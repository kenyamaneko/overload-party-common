...
Outputs:
  - packages/gamedata/cache/products_gen.json  (Go embedded, local dev)
...
def generate_seed_sql(products, *, out_path):
    ...
    lines.append("  (product_id, name, type, price, content, description, image_url, is_active)")
    lines.append("VALUES")
    ...
    for p in products:
        ...
        row = f"  ({pid}, {name}, {ptype}, {price}, {content}, {description}, {image_url}, {is_active})"
