...
_GENERATED_HEADER_GO = "// Code generated by scripts/generate_constants.py; DO NOT EDIT."
_GENERATED_HEADER_CS = "// Code generated by scripts/generate_constants.py; DO NOT EDIT."
_GENERATED_HEADER_TS = "// Code generated by scripts/generate_constants.py; DO NOT EDIT."
...
def generate_go_constants(constants, *, out_path):
    ...
    lines.append(f"\tcase {', '.join(f'Restriction{_to_pascal(v)}' for v in constants['restriction_values'])}:")
    lines.append("\t}")
    # Generate explicit cases for clarity.
    lines_pop = lines.pop()  # Remove the closing brace we just added
    lines_pop2 = lines.pop()  # Remove the combined case
    lines.append(f"\tcase RestrictionForbidden:")
    lines.append("\t\treturn 0")
    lines.append(f"\tcase RestrictionLimited:")
    lines.append("\t\treturn 1")
    lines.append(f"\tcase RestrictionSemiLimited:")
