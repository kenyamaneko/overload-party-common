<!-- このファイルは overload-party-common/rules/flow/gitflow/CLAUDE.md から同期されています。編集はそちらで行ってください。 -->
...
- ブランチ戦略の詳細は [rules/flow/gitflow/BRANCHING.md](rules/flow/gitflow/BRANCHING.md) を参照
