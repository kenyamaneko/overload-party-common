<!-- このファイルは overload-party-common/rules/flow/githubflow/CLAUDE.md から同期されています。編集はそちらで行ってください。 -->
...
- ブランチ戦略の詳細は [rules/flow/githubflow/BRANCHING.md](rules/flow/githubflow/BRANCHING.md) を参照
