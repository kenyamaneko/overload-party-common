...
INSERT INTO card_definitions (card_id, card_name, faction, card_type, resizable, elastic, stats, effect_text, restriction, is_active, created_at, updated_at)
VALUES
('SH-0001', 'EC2 Instance', 'SD', 'Compute', true, true,
...
('TK-0001', 'Cloud Functions', 'Tenki', 'Serverless', false, true,
...
('TN-0001', 'Azure Cosmos DB', 'Tuners', 'Database', true, true,
