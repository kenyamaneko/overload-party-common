...
INSERT INTO card_definitions (card_no, card_name, faction, card_type, resizable, elastic, stats, effect_text, restriction, is_active, created_at, updated_at)
VALUES
(1, 'EC2 Instance', 'SD', 'Compute', true, true,
...
(2, 'Cloud Functions', 'Tenki', 'Serverless', false, true,
...
(5, 'Azure Cosmos DB', 'Tuners', 'Database', true, true,
