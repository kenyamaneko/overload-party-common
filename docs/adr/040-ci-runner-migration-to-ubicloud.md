...
- Supersedes: ADR-038 のサードパーティ runner 却下判断 (代替案 B / Out of scope の Ubicloud 部分)
...
CI runner を `ubicloud-standard-2` に切り替える。
...
- GitHub-hosted 超過課金の削減
- WIF 改修不要、リスクは workflow ファイル変更に限定
