...
export const WS_SERVER_MSG_TYPES = ["game_state", "game_over", "error", "game_entered", "matchmaking_started", "matchmaking_cancelled", "action_rejected", "stamp_used", "pong", "match_found", "game_state_restore", "action_performed", "turn_controls", "npc_battle_created"] as const;
